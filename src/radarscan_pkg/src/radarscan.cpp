  ...
  ui(new Ui::radarScan)
{
  ...
  // setup subscriber by accoding to the ttcRadar _topic param
  string listen_topic;
  n.param<string>("listen_topic",listen_topic,"/talker/chatter");
  sub = n.subscribe<std_msgs::String>("chatter", 1, &radarScan::chatterCallback, this) ;

  test1.distance.push_back(5);
}
...
void radarScan::chatterCallback(const std_msgs::String::ConstPtr &msg)
{
